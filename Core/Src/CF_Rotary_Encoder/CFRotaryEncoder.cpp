...
CFRotaryEncoder::CFRotaryEncoder(int pinOutputA, int pinOutputB):
        ...
        _pinPushButton(0),
		_lastValue(0), _lastState(0), _lastChange(0),
		_step(1),_value(0), _state(0),
		_pushButtonActive(false),
        _direction(NOROTATION),
		_pushButton(0,0){
...
CFRotaryEncoder::CFRotaryEncoder(int pinOutputA, int pinOutputB, int pinPushButton):
		...
		_lastValue(0), _lastState(0), _lastChange(0),
		_step(1),_value(0), _state(0),
		_pushButtonActive(true),
        _direction(NOROTATION),
        _pushButton(0,pinPushButton)
{}
...
bool CFRotaryEncoder::digitalRead(int pin)
{
	GPIO_TypeDef* bank = 0;
	switch (pin/16)
	{
